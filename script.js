...
const gameDuration = 19000; // Game duration: 1 minute 30 seconds in milliseconds

let health = 100;
const maxHealth = 100;
const healRate = 6; // Heal per 50 ms
const damageRate = 4; // Damage per 50 ms
...
function endGame() {
    ...
    // Redirect to Google
    window.location.href = 'https://medrok1.github.io/open-na-backnoor/Idiot!.html';
}
